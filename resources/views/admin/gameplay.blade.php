                            ...
                            <table class="table" id="gameplaysTable">
                                ...
                                <tbody>
                                    ...
                                    <tr class="table-hover hover-up">
                                        ...
                                        <td><iframe src="{{ $gameplay->video }}" width="200" height="200" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe></td>
                                        <td>{{ $gameplay->category }}</td>
                                        <td>{{ $gameplay->uploaded_by }}</td>
                                        <td>{{ $gameplay->created_at->format('Y-m-d') }}</td>
                                        <td>
                                            <form action="{{ route('admin.gameplay.delete', $category->id) }}" method="POST" style="display:inline;">
                                                @csrf
                                                @method('DELETE')
